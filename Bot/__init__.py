...
LOG = logging.getLogger("Bot by @ItzMonkeyDLuffy")
...
BOT_NAME = os.environ.get('BOT_NAME', 'ItzMonkeyDLuffy')
#<---------------Connecting-------------->
if BOT_TOKEN is not None:
    try:
        encoder  = Client('AutoEncoder', api_id=API_ID, api_hash=APP_HASH, bot_token=BOT_TOKEN, plugins=dict(root="Bot/plugins"))
        LOG.info('❤️ Bot Connected Created By Github @ItzMonkeyDLuffy || Telegram @ItzMonkeyDLuffy ')
